...
/*    */ 
/*    */ 
/*    */ public class ZXDSK3PlayHandler
...
/* 29 */         char[] bnums = nums[i].toCharArray();
/* 30 */         Arrays.sort(bnums);
/* 31 */         StringBuilder sb = new StringBuilder();
/* 32 */         for (char bnum : bnums) {
/* 33 */           sb.append(bnum);
/*    */         }
...
/* 53 */     if ((nums == null) || (openNum == null)) {
/* 54 */       return result;
/*    */     }
/* 56 */     StringBuilder sb = new StringBuilder();
/* 57 */     for (String nm : openNum) {
/* 58 */       sb.append(nm.trim());
/*    */     }
/* 60 */     int winNum = 0;
/* 61 */     for (int i = 0; i < nums.length; i++) {
/* 62 */       if (sb.toString().trim().contains(nums[i]))
/*    */       {
/* 64 */         winNum++;
/*    */       }
/*    */     }
...
/* Location:              /Users/vincent/Downloads/至尊程序/lotteryOpen/lotteryOpen.jar!/lottery/domains/pool/play/impl/ZXDSK3PlayHandler.class
