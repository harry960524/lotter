  ...
  implements Serializable, Cloneable
{
  ...
  public AdminUserMenu(String name, String icon, String link, int upid, int sort, int status)
  {
    this.name = name;
    this.icon = icon;
    this.link = link;
  ...
  public AdminUserMenu(String name, String icon, String link, int upid, int sort, int status, int baseAction, String allActions)
  {
    this.name = name;
    this.icon = icon;
    this.link = link;
