...
public abstract interface UserDividendService
{
  public abstract PageList search(List<Integer> paramList, String paramString1, String paramString2, Double paramDouble1, Double paramDouble2, Integer paramInteger1, Integer paramInteger2, Integer paramInteger3, Integer paramInteger4, int paramInt1, int paramInt2);
  ...
  public abstract void checkDividend(String paramString);
  ...
  public abstract int[] getMinMaxUser(User paramUser);
  
  public abstract boolean checkValidLevel(String paramString1, String paramString2, String paramString3, UserDividend paramUserDividend, String paramString4);
}
