...
@Entity
@Table(name="user_main_report", catalog="ecai", uniqueConstraints={@javax.persistence.UniqueConstraint(columnNames={"user_id", "time"})})
public class UserMainReport
  implements Serializable
{
  ...
  public UserMainReport(int userId, double recharge, double withdrawals, double transIn, double transOut, double accountIn, double accountOut, double activity, String time)
  {
    this.userId = userId;
