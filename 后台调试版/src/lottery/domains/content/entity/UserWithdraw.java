...
@Entity
@Table(name="user_withdraw", catalog="ecai", uniqueConstraints={@javax.persistence.UniqueConstraint(columnNames={"billno"})})
  ...
  implements Serializable
{
  ...
  public UserWithdraw(String billno, int userId, double money, double beforeMoney, double afterMoney, double recMoney, double feeMoney, String time, int status, int lockStatus, int checkStatus, int remitStatus)
  {
    this.billno = billno;
    this.userId = userId;
    this.money = money;
