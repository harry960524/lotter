...
@Entity
@Table(name="user_withdraw", catalog="ecaibackup", uniqueConstraints={@javax.persistence.UniqueConstraint(columnNames={"billno"})})
public class HistoryUserWithdraw
  implements Serializable
{
  ...
  public HistoryUserWithdraw(String billno, int userId, double money, double beforeMoney, double afterMoney, double recMoney, double feeMoney, String time, int status, int lockStatus, int checkStatus, int remitStatus)
  {
    this.billno = billno;
    this.userId = userId;
    this.money = money;
  ...
  public HistoryUserWithdraw(String billno, int userId, double money, double beforeMoney, double afterMoney, double recMoney, double feeMoney, String time, int status, String infos, String bankName, String bankBranch, String cardName, String cardId, String payBillno, String operatorUser, String operatorTime, String remarks, int lockStatus, int checkStatus, int remitStatus)
  {
    this.billno = billno;
    this.userId = userId;
    this.money = money;
