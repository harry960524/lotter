...
@Entity
@Table(name="user_bets", catalog="ecaibackup", uniqueConstraints={@javax.persistence.UniqueConstraint(columnNames={"billno", "user_id"})})
public class HistoryUserBets
  implements Serializable, Cloneable
{
  ...
  public HistoryUserBets(String billno, int userId, int type, int lotteryId, String expect, int ruleId, String codes, int nums, String model, int multiple, int code, double point, double money, String time, String stopTime, String openTime, int status, int locked)
  {
    this.billno = billno;
    this.userId = userId;
    this.type = type;
  ...
  public HistoryUserBets(String billno, int userId, int type, int lotteryId, String expect, int ruleId, String codes, int nums, String model, int multiple, int code, double point, double money, String time, String stopTime, String openTime, int status, int isAll, int locked)
  {
    this.billno = billno;
    this.userId = userId;
    this.type = type;
  ...
  public HistoryUserBets(String billno, int userId, int type, int lotteryId, String expect, int ruleId, String codes, int nums, String model, int multiple, int code, double point, double money, String time, String stopTime, String openTime, int status, String openCode, Double prizeMoney, String prizeTime, String chaseBillno, Integer chaseStop, String planBillno, Double rewardMoney, int isAll, int locked)
  {
    this.billno = billno;
    this.userId = userId;
    this.type = type;
