...
public class ActivityRechargeBill
  implements Serializable
{
  ...
  public ActivityRechargeBill(int userId, String ip, double totalMoney, double money, String payTime, String time, int status)
  {
    this.userId = userId;
    this.ip = ip;
