  ...
  implements Serializable
{
  ...
  public UserBetsPlan(String billno, int userId, int orderId, int lotteryId, String expect, int ruleId, int nums, String model, int multiple, double money, double maxPrize, String title, double rate, int followCount, double rewardMoney, String time, int status, double prizeMoney, int part)
  {
    this.billno = billno;
    this.userId = userId;
