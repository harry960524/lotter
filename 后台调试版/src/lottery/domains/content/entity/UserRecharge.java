...
@Entity
@Table(name="user_recharge", catalog="ecai", uniqueConstraints={@javax.persistence.UniqueConstraint(columnNames={"billno"})})
  ...
  implements Serializable
{
  ...
  public UserRecharge(String billno, int userId, double money, double beforeMoney, double afterMoney, double recMoney, double feeMoney, String time, int status, int type, int subtype)
  {
    this.billno = billno;
    this.userId = userId;
    this.money = money;
  ...
  public UserRecharge(String billno, int userId, double money, double beforeMoney, double afterMoney, double recMoney, double feeMoney, String time, int status, int type, int subtype, String postscript, String infos, String payBillno, String payTime, String remarks)
  {
    this.billno = billno;
    this.userId = userId;
    this.money = money;
