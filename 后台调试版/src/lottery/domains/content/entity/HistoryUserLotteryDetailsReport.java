...
public class HistoryUserLotteryDetailsReport
  implements Serializable
{
  ...
  public HistoryUserLotteryDetailsReport(int userId, int lotteryId, int ruleId, double spend, double prize, double spendReturn, double proxyReturn, double cancelOrder, double billingOrder, String time)
  {
    this.userId = userId;
