...
@Entity
@Table(name="user_game_report", catalog="ecai", uniqueConstraints={@javax.persistence.UniqueConstraint(columnNames={"user_id", "platform_id", "time"})})
public class HistoryUserGameReport
