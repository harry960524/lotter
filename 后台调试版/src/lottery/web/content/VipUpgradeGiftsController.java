...
@Controller
public class VipUpgradeGiftsController
  extends AbstractActionController
{
  ...
  @RequestMapping(value={"/vip-upgrade-gifts/list"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void VIP_UPGRADE_GIFTS_LIST(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    String actionKey = "/vip-upgrade-gifts/list";
    ...
    if (uEntity != null)
    {
      if (super.hasAccess(uEntity, actionKey))
      {
        ...
        PageList pList = this.vUpgradeGiftsService.search(username, date, status, start, limit);
        if (pList != null)
        {
