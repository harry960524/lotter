  ...
  extends AbstractActionController
{
  ...
  @RequestMapping(value={"/lottery-payment-channel/simple-list"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void LOTTERY_PAYMENT_CHANNEL_SIMPLE_LIST(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    ...
    if (uEntity != null)
    {
      List<PaymentChannelSimpleVO> list = this.dataFactory.listPaymentChannelVOsSimple();
  ...
  @RequestMapping(value={"/lottery-payment-channel/list"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void LOTTERY_PAYMENT_CHANNEL_LIST(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    String actionKey = "/lottery-payment-channel/list";
    ...
    if (uEntity != null)
    {
      ...
      {
        List<PaymentChannelVO> list = this.paymentChannelService.listAllVOs();
        json.set(Integer.valueOf(0), "0-3");
        json.accumulate("data", list);
      }
      else
  ...
  @RequestMapping(value={"/lottery-payment-channel/get"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  ...
  @RequestMapping(value={"/lottery-payment-channel/add"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void LOTTERY_PAYMENT_CHANNEL_ADD(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    String actionKey = "/lottery-payment-channel/add";
    long t1 = System.currentTimeMillis();
    WebJSONObject json = new WebJSONObject(super.getAdminDataFactory());
    AdminUser uEntity = super.getCurrUser(session, request, response);
    if (uEntity != null)
    {
      if (super.hasAccess(uEntity, actionKey))
      {
        ...
        boolean result = this.paymentChannelService.add(name, mobileName, frontName, channelCode, merCode, totalCredits, minTotalRecharge, maxTotalRecharge, minUnitRecharge, maxUnitRecharge, maxRegisterTime, qrCodeContent, fixedQRAmount, type, subType, consumptionPercent, whiteUsernames, startTime, endTime, fixedAmountQrs, 1);
        if (result)
        {
  ...
  @RequestMapping(value={"/lottery-payment-channel/edit"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void LOTTERY_PAYMENT_CHANNEL_EDIT(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    String actionKey = "/lottery-payment-channel/edit";
    long t1 = System.currentTimeMillis();
    WebJSONObject json = new WebJSONObject(super.getAdminDataFactory());
    AdminUser uEntity = super.getCurrUser(session, request, response);
    if (uEntity != null)
    {
      if (super.hasAccess(uEntity, actionKey))
      {
        ...
        if (fixedQRAmount == null) {
          fixedQRAmount = Integer.valueOf(0);
        }
        if (StringUtils.isNotEmpty(maxRegisterTime)) {
          maxRegisterTime = maxRegisterTime + " 23:59:59";
        }
        boolean result = this.paymentChannelService.edit(id, name, mobileName, frontName, totalCredits, minTotalRecharge, maxTotalRecharge, minUnitRecharge, maxUnitRecharge, maxRegisterTime, qrCodeContent, fixedQRAmount.intValue(), consumptionPercent, whiteUsernames, startTime, endTime, fixedAmountQrs);
        if (result)
        {
  ...
  @RequestMapping(value={"/lottery-payment-channel/update-status"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  ...
  {
    String actionKey = "/lottery-payment-channel/update-status";
    long t1 = System.currentTimeMillis();
    WebJSONObject json = new WebJSONObject(super.getAdminDataFactory());
    AdminUser uEntity = super.getCurrUser(session, request, response);
    if (uEntity != null)
  ...
  @RequestMapping(value={"/lottery-payment-channel/reset-credits"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  ...
  {
    String actionKey = "/lottery-payment-channel/reset-credits";
    long t1 = System.currentTimeMillis();
    WebJSONObject json = new WebJSONObject(super.getAdminDataFactory());
    AdminUser uEntity = super.getCurrUser(session, request, response);
    if (uEntity != null)
    {
      ...
      {
        int id = HttpUtil.getIntParameter(request, "id").intValue();
        boolean result = this.paymentChannelService.resetCredits(id);
        if (result) {
          json.set(Integer.valueOf(0), "0-5");
        } else {
          json.set(Integer.valueOf(1), "1-5");
  ...
  @RequestMapping(value={"/lottery-payment-channel/delete"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void LOTTERY_PAYMENT_CHANNEL_DELETE(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    String actionKey = "/lottery-payment-channel/delete";
    long t1 = System.currentTimeMillis();
    WebJSONObject json = new WebJSONObject(super.getAdminDataFactory());
    AdminUser uEntity = super.getCurrUser(session, request, response);
    if (uEntity != null)
  ...
  @RequestMapping(value={"/lottery-payment-channel/move-up"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void LOTTERY_PAYMENT_CHANNEL_MOVEUP(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    String actionKey = "/lottery-payment-channel/move-up";
    long t1 = System.currentTimeMillis();
    WebJSONObject json = new WebJSONObject(super.getAdminDataFactory());
    AdminUser uEntity = super.getCurrUser(session, request, response);
    if (uEntity != null)
    {
      ...
      {
        int id = HttpUtil.getIntParameter(request, "id").intValue();
        boolean result = this.paymentChannelService.moveUp(id);
        if (result) {
          json.set(Integer.valueOf(0), "0-5");
        } else {
          json.set(Integer.valueOf(1), "1-5");
  ...
  @RequestMapping(value={"/lottery-payment-channel/move-down"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void LOTTERY_PAYMENT_CHANNEL_MOVEDOWN(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    String actionKey = "/lottery-payment-channel/move-down";
    long t1 = System.currentTimeMillis();
    WebJSONObject json = new WebJSONObject(super.getAdminDataFactory());
    AdminUser uEntity = super.getCurrUser(session, request, response);
    if (uEntity != null)
    {
      ...
      {
        int id = HttpUtil.getIntParameter(request, "id").intValue();
        boolean result = this.paymentChannelService.moveDown(id);
        if (result) {
          json.set(Integer.valueOf(0), "0-5");
        } else {
          json.set(Integer.valueOf(1), "1-5");
