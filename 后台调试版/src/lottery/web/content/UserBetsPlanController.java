...
@Controller
public class UserBetsPlanController
  extends AbstractActionController
{
  ...
  @RequestMapping(value={"/lottery-user-bets-plan/list"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void LOTTERY_USER_BETS_PLAN_LIST(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    String actionKey = "/lottery-user-bets-plan/list";
    ...
    if (uEntity != null)
    {
      if (super.hasAccess(uEntity, actionKey))
      {
        ...
        PageList pList = this.uBetsPlanService.search(keyword, username, lotteryId, expect, ruleId, minTime, maxTime, minMoney, maxMoney, minMultiple, maxMultiple, status, start, limit);
        if (pList != null)
        {
