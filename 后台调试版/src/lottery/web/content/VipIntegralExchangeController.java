...
@Controller
public class VipIntegralExchangeController
  extends AbstractActionController
{
  ...
  @RequestMapping(value={"/vip-integral-exchange/list"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void VIP_INTEGRAL_EXCHANGE_LIST(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    String actionKey = "/vip-integral-exchange/list";
    ...
    if (uEntity != null)
    {
      if (super.hasAccess(uEntity, actionKey))
      {
        ...
        PageList pList = this.vIntegralExchangeService.search(username, date, start, limit);
        if (pList != null)
        {
