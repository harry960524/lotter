  ...
  extends AbstractActionController
{
  ...
  @RequestMapping(value={"/lottery/list"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void LOTTERY_LIST(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    ...
    if (uEntity != null)
    {
      ...
      List<LotteryVO> list = this.lotteryService.list(type);
  ...
  @RequestMapping(value={"/lottery/update-status"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void LOTTERY_USER_UPDATE_STATUS(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    String actionKey = "/lottery/update-status";
    ...
    if (uEntity != null)
    {
      if (super.hasAccess(uEntity, actionKey))
      {
        ...
        boolean result = this.lotteryService.updateStatus(id, status);
        if (result) {
