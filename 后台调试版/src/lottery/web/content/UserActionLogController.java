  ...
  extends AbstractActionController
{
  ...
  @RequestMapping(value={"/lottery-user-action-log/list"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void LOTTERY_USER_ACTION_LOG_LIST(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    String actionKey = "/lottery-user-action-log/list";
    ...
    if (uEntity != null)
    {
      if (super.hasAccess(uEntity, actionKey))
      {
        ...
        PageList pList = this.uActionLogService.search(username, ip, keyword, date, start, limit);
        if (pList != null)
        {
