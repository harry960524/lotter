...
@Controller
public class UserBalanceSnapshotController
  extends AbstractActionController
{
  ...
  @RequestMapping(value={"/user-balance-snapshot/list"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void USER_BALANCE_SNAPSHOT_LIST(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    String actionKey = "/user-balance-snapshot/list";
    ...
    if (uEntity != null)
    {
      if (super.hasAccess(uEntity, actionKey))
      {
        ...
        PageList pList = this.uBalanceSnapshotService.search(sDate, eDate, start, limit);
        if (pList != null)
        {
