  ...
  extends AbstractActionController
{
  ...
  @RequestMapping(value={"/lottery-user-withdraw-log/list"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void LOTTERY_USER_UPDATE_LOG(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    String actionKey = "/lottery-user-withdraw-log/list";
    ...
    if (uEntity != null)
    {
      if (super.hasAccess(uEntity, actionKey))
      {
        ...
        PageList pList = this.userWithdrawLogService.search(billno, username, start, limit);
        if (pList != null)
        {
