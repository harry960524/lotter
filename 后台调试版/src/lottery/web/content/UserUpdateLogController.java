  ...
  extends AbstractActionController
{
  ...
  @RequestMapping(value={"/lottery-user-update-log/list"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  @ResponseBody
  public void LOTTERY_USER_UPDATE_LOG(HttpSession session, HttpServletRequest request, HttpServletResponse response)
  {
    String actionKey = "/lottery-user-update-log/list";
    ...
    if (uEntity != null)
    {
      if (super.hasAccess(uEntity, actionKey))
      {
        ...
        PageList pList = this.adminUserCriticalLogService.search(username, start, limit);
        if (pList != null)
        {
