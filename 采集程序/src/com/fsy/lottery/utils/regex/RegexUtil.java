/*     */ package com.fsy.lottery.utils.regex;
/*     */ 
/*     */ import java.io.PrintStream;
/*     */ import java.util.regex.Matcher;
/*     */ import java.util.regex.Pattern;
/*     */ import com.fsy.lottery.utils.StringUtil;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     try {
/* 173 */       if (StringUtil.isNotNull(s)) {
/* 174 */         Pattern pattern = Pattern.compile(regex);
/* 175 */         Matcher matcher = pattern.matcher(s);
/* 176 */         flag = matcher.matches();
/*     */       }
/*     */     }
/*     */     catch (Exception e) {
/* 180 */       System.out.println("匹配失败！");
/*     */     }
/* 182 */     return flag;
/*     */   }
/*     */ }
